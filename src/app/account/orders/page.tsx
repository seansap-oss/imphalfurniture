...
export default function OrdersPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-3 sm:px-4 py-6">
      ...
      {orders.length === 0 ? <div className="bg-white border rounded-2xl p-10 text-center mt-4"><p className="font-extrabold">No orders yet</p><a href="/" className="inline-block mt-3 bg-[#D21F26] text-white font-bold px-6 py-2.5 rounded-full">Start shopping</a></div>
